...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Yoo, I'm BusyBruce 👋</h2>
                    <p>This is BusyBruce's OneDrive public directory listing. Feel free to download any files that you find useful. </p>
                    <p><a href="https://github.com/BusyBruce">GitHub</a></p>
                  </div>`
